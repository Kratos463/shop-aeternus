                                            ...
                                            <div className="category-menu-content">
                                                ...
                                                <div className="right-section">
                                                    ...
                                                    <ul className='subcategory-listing'>
                                                        <h2 className='categorylisting-h2'>{category.Category}</h2>
                                                        ...
                                                        {subcategoriesMap[category.Category_id] &&
                                                            ...
                                                            <>
                                                                ...
                                                                {/*------Second list for additional subcategories----*/}

                                                                {/* <div className='rightsubsection'>
                                                                    {subcategoriesMap[category.Category_id].length > 4 && (
                                                                        <ul className='subcategory-listing'>
                                                                            {subcategoriesMap[category.Category_id]
                                                                                .slice(4) //listing the catogories from where more than 5 if there
                                                                                .map((subcategory) => (
                                                                                    <li
                                                                                        key={subcategory.Category_id}
                                                                                        onMouseEnter={() => handleSubcategoryHover(subcategory.Category_id)}
