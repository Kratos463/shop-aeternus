    ...
    <>
      <div className={`product-right ${stickyClass}`}>
        ...
        <div className="product-buttons">
          ...
          {/* Add to cart Button */}
          <button onClick={() => addToCart(user, product, colors[0], sizes[0], quantity)} className="btn btn-solid">
            Add to Cart
          </button>

          {/* Buy now Button */}
          <Link href={`/page/account/checkout`} className="btn btn-solid" onClick={() => addToCart(user, product, colors[0], sizes[0], quantity)}>
            buy now
          </Link>
        </div>
